    ...
    public class CatalogoController : Controller
    {
        private static List<Item> _items = new()
        {
            ...
            new Item {
                ...
                Ano = 1997,
                Consola = "PlayStation",
                Descripcion = "Alucard, hijo de Drácula, debe explorar el castillo de su padre para detener a Richter Belmont."
            },
            new Item {
                Id = 3,
                ...
                Descripcion = "Androides del futuro luchan contra máquinas alienígenas en una Tierra postapocalíptica."
            }
        };
